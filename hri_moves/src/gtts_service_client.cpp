...
GttsServiceClient::GttsServiceClient(const rclcpp::NodeOptions & options)
  ...
  this->client_ptr_ =  this->create_client<hri_interfaces::srv::TextToSpeech>("gtts_service");
...
RCLCPP_COMPONENTS_REGISTER_NODE(hri_gtts_service_client::GttsServiceClient)