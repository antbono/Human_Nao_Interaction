...
#include "hri_moves/joints_play_action_server.hpp"

namespace hri_joints_play_action_server {
...
RCLCPP_COMPONENTS_REGISTER_NODE(hri_joints_play_action_server::JointsPlayActionServer)