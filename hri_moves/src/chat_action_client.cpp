...
#include "hri_moves/chat_action_client.hpp"
...
ChatActionClient::ChatActionClient(const rclcpp::NodeOptions & options)
  ...
  this->client_ptr_ = rclcpp_action::create_client<hri_interfaces::action::ChatPlay>(
                        this,
                        "chat_play");
...
void ChatActionClient::sendAsyncGoal() {
  ...
  auto goal_msg = hri_interfaces::action::ChatPlay::Goal();

  auto send_goal_options =  rclcpp_action::Client<hri_interfaces::action::ChatPlay>::SendGoalOptions();
...
RCLCPP_COMPONENTS_REGISTER_NODE(hri_chat_action_client::ChatActionClient)