...
#ifndef HRI_MOVES__GTTS_SERVICE_CLIENT_HPP_
#define HRI_MOVES__GTTS_SERVICE_CLIENT_HPP_
...
namespace hri_gtts_service_client {
...
class GttsServiceClient : public rclcpp::Node {
  ...
  rclcpp::Client<hri_interfaces::srv::TextToSpeech>::SharedPtr client_ptr_;
...
#endif //HRI_MOVES__GTTS_SERVICE_CLIENT_HPP_