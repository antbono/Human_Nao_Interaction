...
#ifndef HRI_MOVES__LED_ACTION_SERVER_HPP_
#define HRI_MOVES__LED_ACTION_SERVER_HPP_
...
class LedsPlayActionServer : public rclcpp::Node 
{
  ...
  private:
	...
	rclcpp_action::Server<hri_interfaces::action::LedsPlay>::SharedPtr action_server_;
	std::shared_ptr<rclcpp_action::ServerGoalHandle<hri_interfaces::action::LedsPlay>> goal_handle_;
...
#endif  // HRI_MOVES__LED_ACTION_SERVER_HPP_